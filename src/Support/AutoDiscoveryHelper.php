...
class AutoDiscoveryHelper
{
    ...
    public function langDirectoryPublicFinder(): FinderCollection
	{
		return FinderCollection::forDirectories()
			->depth(0)
			->name('lang')
			->inOrEmpty($this->base_path.'/*/src/resources/public');
	}
    ...
    public function configDirectoryPublicFinder(): FinderCollection
	{
		return FinderCollection::forFiles()
			->name('*.php')
			->inOrEmpty($this->base_path.'/*/src/config/public');
	}
}
